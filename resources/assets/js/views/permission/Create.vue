<template lang="html">
  <vue-form :title="$t('form.create_permission')">
      <div slot="buttons">
          ...
          <div class="row">
              <form class="form col-md-4 col-md-offset-4" role="form" @submit.prevent="create">
                  <div class="form-group">
                      <label for="name">{{ $t('form.permission') }}</label>
                      <input type="text" class="form-control" id="name" :placeholder="$t('form.permission')" name="name">
                  </div>
                  <div class="form-group">
